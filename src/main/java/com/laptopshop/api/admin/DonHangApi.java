...
public class DonHangApi {
	...
	@GetMapping("/reportPareto/{type}")
	public List<Object[]> reportPareto(@PathVariable String type) {
		return donHangService.reportPareto(type);
	}

	@GetMapping("/report-top-products")
	public List<Object[]> getTopProductsByMonthAndYear(
			@RequestParam("month") int month) {

		return donHangService.getTop5ProductsByMonth(month);
	}
}
